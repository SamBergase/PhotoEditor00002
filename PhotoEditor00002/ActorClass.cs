...
namespace PhotoEditor00002
{
    ...
    class ActorClass
    {
        ...
        public void loadActor(string userID)
        {
            ...
            if (System.IO.File.Exists(filename))
            {
                foreach (string line in System.IO.File.ReadLines(filename))
                {
                    if (line != "-1")
                    {
                        int dp0, dp1, dp2, dp3, dp4, dp5, dp6, dp7, dp8, dp9, dp10, dp11, dp12, dp13, dp14;
                                                                        ...
                                                                        if ((dp8 > 0) && (dp8 < dataInfo.Length - 1))
                                                                        {
                                                                            ...
                                                                            if ((dp9 > 0) && (dp9 < dataInfo.Length - 1))
                                                                            {
                                                                                ...
                                                                                if ((dp10 > 0) && (dp10 < dataInfo.Length - 1))
                                                                                {
                                                                                    ...
                                                                                    dataInfo = dataInfo.Substring(dp10 + 2, dataInfo.Length - dp10 - 2);
                                                                                    // Currency
                                                                                    if ((dataInfo == "Euro") || (dataInfo == "euro") || (dataInfo == "EUR") || (dataInfo == "eur"))
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.EUR;
                                                                                    else if ((dataInfo == "Brittish Pounds") || (dataInfo == "Pounds") || (dataInfo == "GBP") ||
                                                                                             (dataInfo == "brittish pounds") || (dataInfo == "pounds") || (dataInfo == "gbp"))
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.GBP;
                                                                                    else if ((dataInfo == "Swedish Crones") || (dataInfo == "Swedish Krones") || (dataInfo == "Swedish") || (dataInfo == "Kronor") || (dataInfo == "Crones") || (dataInfo == "Krones") || (dataInfo == "SEK") ||
                                                                                             (dataInfo == "swedish crones") || (dataInfo == "swedish krones") || (dataInfo == "swedish") || (dataInfo == "kronor") || (dataInfo == "crones") || (dataInfo == "krones") || (dataInfo == "sek"))
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.SEK;
                                                                                    else if ((dataInfo == "Mongol") || (dataInfo == "Mongol Tugruk") || (dataInfo == "Tugruk") || (dataInfo == "MNT") ||
                                                                                             (dataInfo == "mongol") || (dataInfo == "mongol tugruk") || (dataInfo == "tugruk") || (dataInfo == "mnt"))
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.MNT;
                                                                                    else if ((dataInfo == "US") || (dataInfo == "Dollars") || (dataInfo == "USD") || (dataInfo == "US Dollars") ||
                                                                                             (dataInfo == "us") || (dataInfo == "dollars") || (dataInfo == "usd") || (dataInfo == "us dollars"))
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.USD;
                                                                                    else
                                                                                        anvBostader[noOfResidences].currency = CurrencyUnits.UndefCurrencyUnit;
                                                                                    noOfDataSet++;
                                                                                }
                                                                            }
                                                                        }
                            ...
                            case "HairColr":
                                {
                                    ...
                                    if (noOfHairData < maxNoOfHairData)
                                    {
                                        ...
                                        if ((dp0 > 0) && (dp0 < dataInfo.Length - 2))
                                        {
                                            ...
                                            if ((clrtg == "Black") || (clrtg == "black"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Black;
                                            else if ((clrtg == "Dark Brown") || (clrtg == "dark brown"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.DarkBrown;
                                            else if ((clrtg == "Brown") || (clrtg == "brown"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Brown;
                                            else if ((clrtg == "Light Brown" || clrtg == "light brown"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.LightBrown;
                                            else if ((clrtg == "Dark Chestnut") || (clrtg == "dark chestnut"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.DarkChestnut;
                                            else if ((clrtg == "Chestnut") || (clrtg == "chestnut"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Chestnut;
                                            else if ((clrtg == "Light Chestnut") || (clrtg == "light chestnut"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.LightChestnut;
                                            else if ((clrtg == "Dark Red") || (clrtg == "dark red"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.DarkRed;
                                            else if ((clrtg == "Red") || (clrtg == "red"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Red;
                                            else if ((clrtg == "Light Red") || (clrtg == "light red") ||
                                                     (clrtg == "Red Blond") || (clrtg == "red blond") ||
                                                     (clrtg == "Red-Blond") || (clrtg == "red-blond"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.LightRed;
                                            else if ((clrtg == "Dark Gray") || (clrtg == "dark gray") ||
                                                     (clrtg == "Dark Grey") || (clrtg == "dark grey"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.DarkGray;
                                            else if ((clrtg == "Gray") || (clrtg == "gray") ||
                                                     (clrtg == "Grey") || (clrtg == "grey"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Gray;
                                            else if ((clrtg == "Light Gray") || (clrtg == "light gray") ||
                                                     (clrtg == "Light Grey") || (clrtg == "light grey"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.LightGray;
                                            else if ((clrtg == "Green") || (clrtg == "green"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Green;
                                            else if ((clrtg == "Blue") || (clrtg == "blue"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Blue;
                                            else if ((clrtg == "Pink") || (clrtg == "ping"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Pink;
                                            else if ((clrtg == "Lilac") || (clrtg == "lilac"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Lilac;
                                            else if ((clrtg == "Orange") || (clrtg == "orange"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.Orange;
                                            else if ((clrtg == "Mixed Color") || (clrtg == "mixed color") || (clrtg == "Mixed") || (clrtg == "mixed"))
                                                anvHaar[noOfHairData].colorTag = HairColorType.MixedColor;
                                            else
                                                anvHaar[noOfHairData].colorTag = HairColorType.UndefHairColor;
                                            dataInfo = dataInfo.Substring(dp0 + 2, dataInfo.Length - dp0 - 2);
                                            dp1 = dataInfo.IndexOf(";");
                            ...
                            case "Attended":
                                {
                                    ...
                                    if (noOfAttendedEventData < maxNoOfAttendedEventData)
                                    {
                                        ...
                                        if ((dp0 > 0) && (dp0 < dataInfo.Length - 2))
                                        {
                                            // Event ID; Event-Type-tag; Start-Date-Time; End-Date-Time;
                                            ...
                                            if ((dp1 > 0) && (dp1 < dataInfo.Length - 2))
                                            {
                                                // Event-Type-tag; Start-Date-Time; End-Date-Time;
                                                string evtp = dataInfo.Substring(0, dp1);
                                                // TODO - this list should be handled from User Data.
                                                if ((evtp == "Party") || (evtp == "party"))
                                                    anvTillstallningar[noOfAttendedEventData].type = EventType.Party;
                                                else if ((evtp == "Photo Session") || (evtp == "photo session"))
                                                    anvTillstallningar[noOfAttendedEventData].type = EventType.PhotoSession;
                                                else if ((evtp == "Picnic") || (evtp == "picnic"))
                                                    anvTillstallningar[noOfAttendedEventData].type = EventType.Picnic;
                                                else
                                                    anvTillstallningar[noOfAttendedEventData].type = EventType.UndefEvent;
                                                dataInfo = dataInfo.Substring(dp1 + 2, dataInfo.Length - dp1 - 2);
                                                dp2 = dataInfo.IndexOf(";");
                                                if ((dp2 > 0) && (dp2 < dataInfo.Length - 2))
                                                {
                                    ...
                                    if (noOfRelatedImagesData < maxNoOfRelatedImagesData)
                                    {
                                        ...
                                        if ((dp0 > 0) && (dp0 < dataInfo.Length - 2))
                                        {
                                            ...
                                            if ((dp1 > 0) && (dp1 < dataInfo.Length - 2))
                                            {
                                                ...
                                                if ((toct == "Portrait") || (toct == "portrait"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Portrait;
                                                else if ((toct == "Architecture") || (toct == "architecture"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Architecture;
                                                else if ((toct == "Nature") || (toct == "nature"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Nature;
                                                else if ((toct == "Transportations") || (toct == "transportation") || (toct == "Transport") || (toct == "transport"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Transportations;
                                                else if ((toct == "Garden") || (toct == "garden"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Garden;
                                                else if ((toct == "Erotic") || (toct == "erotic"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Erotic;
                                                else if ((toct == "Porn") || (toct == "porn"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.Porn;
                                                else if ((toct == "Hard Core Porn") || (toct == "hard core porn") ||
                                                         (toct == "Hard Core") || (toct == "hard core"))
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.HardCorePorn;
                                                else
                                                    anvRelBilder[noOfRelatedImagesData].contentClassification = ContextType.UndefContext;
                                                dataInfo = dataInfo.Substring(dp1 + 2, dataInfo.Length - dp1 - 2);
                                                // Security-Level
        ...
        public string getUserContactType(int nr) { return anvKontakter[nr].contactType.ToString(); }
        ...
        public bool addUserContact(string type, string path)
        {
            if (noOfContacts < maxNoOfContacts)
            {
                ...
                if ((type == "Email") || (type == "email"))
                    ...
                    anvKontakter[noOfContacts].contactType = ContactType.Phone;
                else if ((type == "Website") || (type == "website"))
                    anvKontakter[noOfContacts].contactType = ContactType.Website;
                else if ((type == "Facebook") || (type == "facebook"))
                    anvKontakter[noOfContacts].contactType = ContactType.Facebook;
                else if ((type == "Twitter") || (type == "twitter"))
                    anvKontakter[noOfContacts].contactType = ContactType.Twitter;
                else if ((type == "LinkedIn") || (type == "Linkedin") || (type == "linkedin"))
                    anvKontakter[noOfContacts].contactType = ContactType.LinkedIn;
                else if ((type == "Instagram") || (type == "instagram"))
                    anvKontakter[noOfContacts].contactType = ContactType.Instagram;
                else if ((type == "Snapchat") || (type == "snapchat"))
                    anvKontakter[noOfContacts].contactType = ContactType.Snapchat;
                else
                    anvKontakter[noOfContacts].contactType = ContactType.UndefContactType;
        ...
        public bool setUserBirthDate(string instr)
        {
            ...
            if ((dp0 > 0) && (dp0 < instr.Length - 1))
            {
                ...
                if (instr.Length > 9)
                {
                    ...
                    string mtstr = instr.Substring(5, 2);
                    string dystr = instr.Substring(8, 2);
                ...
                else if (instr.Length > 7)
                {
                    ...
                    string mtstr = instr.Substring(3, 2);
                    string dystr = instr.Substring(6, 2);
                    anvFodlseData.brthDate.year = 1900 + int.Parse(yrstr);
                    anvFodlseData.brthDate.month = int.Parse(mtstr);
                    anvFodlseData.brthDate.day = int.Parse(dystr);
                }
                ...
                {
                    anvFodlseData.brthDate.year = 0;
                    anvFodlseData.brthDate.month = 0;
                    anvFodlseData.brthDate.day = 0;
                }
            }
            else
            {
                ...
                // Possible formats: [YYYYMMDD(8)|YYMMDD(6)|YYYYMM(6)|YYMM(4)|YYYY(4)|YY(2)]
                if (instr.Length > 7)
                {
                    // Format YYYYMMDD
                    string yrstr = instr.Substring(0, 4);
        ...
        public string getUserHairColor(int nr) { return anvHaar[nr].colorTag.ToString(); }
        ...
        public string getActorResidBoughtValue(int nr) { return anvBostader[nr].boughtValue.ToString() + " " + anvBostader[nr].currency.ToString(); }
        public string getActorResidSalesValue(int nr) { return anvBostader[nr].salesValue.ToString() + " " + anvBostader[nr].currency.ToString(); }
        ...
        public string getActorAttendedEventType(int nr) { return anvTillstallningar[nr].type.ToString(); }
        ...
        public string getActorRelatedImageContent(int nr) { return anvRelBilder[nr].contentClassification.ToString(); }
